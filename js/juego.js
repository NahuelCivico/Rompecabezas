...
function intercambiarPosiciones(filaPos1, columnaPos1, filaPos2, columnaPos2){
    ...
    var pieza1 = document.getElementById(`${pos1}`);
    var Clon1 = pieza1.cloneNode(true);

    var pieza2 = document.getElementById(`${pos2}`);
    var Clon2 = pieza2.cloneNode(true);

    var body = pieza1.parentNode;
    body.replaceChild(Clon2, pieza1);
    body.replaceChild(Clon1, pieza2);
}
